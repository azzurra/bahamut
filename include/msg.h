...
#define MSG_GUEST    "GUEST"		/* Guest command for JavaCR */
#define MSG_UMODE    "UMODE"		/* umode */
#define MSG_SPAM     "SPAM"		/* spam sux */
...
extern int m_umode2(aClient *, aClient *, int, char **);
extern int m_spam(aClient *, aClient *, int, char **);
