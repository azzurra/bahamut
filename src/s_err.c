...
# ifdef HIGHEST_CONNECTION
    ...
    /* 522 ERR_WHOSYNTAX */	":%s 522 %s :/WHO Syntax incorrect, use "
                                "/who ? for help",
    /* 523 ERR_WHOLIMEXCEED */	":%s 523 %s :Error, /who limit of %d exceeded."
    ...
    /* 628 */	                NULL,
    /* 629 */	                NULL,
    /* 630 ERR_NOCTCPSTOCHAN */	":%s 630 %s %s :You cannot send CTCPs "
                                        "to this channel. Not sent: %s",
    /* 631 */	                NULL,
    /* 632 */	                NULL,
    /* 633 */	                NULL,
    /* 634 */	                NULL,
    ...
    /* 726 */	                NULL,
    /* 727 */	                NULL,
    /* 728 RPL_RESTRICTLIST */       ":%s 728 %s %s z %s %s %lu",
    /* 729 RPL_ENDOFRESTRICTLIST */  ":%s 729 %s %s z :End of Channel Restrict List",
    /* 730 */	                NULL,
    /* 731 */	                NULL,
    /* 732 */	                NULL,
    /* 733 */	                NULL,
